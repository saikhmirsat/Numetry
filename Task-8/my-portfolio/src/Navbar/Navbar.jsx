...
export default function Navbar({ home, about, skills, projects, contacts }) {
    ...
    // console.log(navhome, navcontact, navabout, navproject, navskill)
    ...
    return (
        <div>
            <div className={navbar ? "navbar active" : "navbar"}>
                <div className={navhome ? "activeNavItme" : "navitem"} onClick={() => {
                    home()
                    setHome(true)
                    setAbout(false)
                    setContact(false)
                ...
                <div className={navabout ? "activeNavItme" : "navitem"} onClick={() => {
                    about()
                    setHome(false)
                    setAbout(true)
                    setContact(false)
                ...
                <div className={navskill ? "activeNavItme" : "navitem"} onClick={() => {
                    skills()
                    setHome(false)
                    setAbout(false)
                    setContact(false)
                ...
                <div className={navproject ? "activeNavItme" : "navitem"} onClick={() => {
                    projects()
                    setHome(false)
                    setAbout(false)
                    setContact(false)
                ...
                <div className={navcontact ? "activeNavItme" : "navitem"} onClick={() => {
                    contacts()
                    setHome(false)
                    setAbout(false)
                    setContact(true)
                ...
                <div className='nav-resume-btn'>
                    ...
                    >Resume  <ImDownload /></h4></a>
                </div>
            </div>
            <div className='mobile_navbar'>
                <MobileNav home={home} about={about} skills={skills} projects={projects} contacts={contacts} />
            </div>
        </div>
    )
}
